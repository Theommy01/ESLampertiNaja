...
input_size = 2570  # Amount of measurements before they enter network/input layer size

layer_limit = 14  # Max number of layers

# Transition Options
possible_conv_depths = [4, 8, 16, 32, 64, 128] # Choices for number of filters in a convolutional layer
possible_conv_sizes = [3, 5, 7, 15, 25]  # Choices for kernel size
possible_pool_sizes = [2, 4, 8, 20, 50]  # Choices for filter_size for an average pooling layer
...
possible_fc_sizes = [16, 32, 64, 128, 256]
